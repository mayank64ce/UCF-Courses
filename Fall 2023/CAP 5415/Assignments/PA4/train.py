...
def run_main(FLAGS):
    ...
    run = wandb.init(
        ...
        project=f"PA4 Model training in {FLAGS.mode} mode.",
    ...
    if FLAGS.mode == 1:
        ...
        from models import ClassifierExtended
        model = ClassifierExtended().to(device)
    else:
    ...
    train_loader, test_loader = get_data_loaders(FLAGS.batch_size)
